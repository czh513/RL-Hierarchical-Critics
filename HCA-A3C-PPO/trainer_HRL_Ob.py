...
class PPOTrainer(Trainer):
    ...
    def construct_curr_info(self, next_info: BrainInfo) -> BrainInfo:
        ...
        curr_info = BrainInfo(visual_observations, vector_observations[:,:8], text_observations,
    ...
    def construct_curr_info2(self, next_info: BrainInfo) -> BrainInfo:
        ...
        for agent_id in next_info.agents:
            ...
            vector_observations2.append(agent_brain_info.vector_observations[agent_index1],agent_brain_info2.vector_observations[agent_index2])
        ...
        curr_info2 = BrainInfo(visual_observations, vector_observations2, text_observations,
                              memories, rewards, agents, local_dones, prev_vector_actions,
                              prev_text_actions, max_reacheds)
        return curr_info2
    ...
    def add_experiences(self, curr_all_info: AllBrainInfo, next_all_info: AllBrainInfo, take_action_outputs):
        ...
        for agent_id in curr_info2.agents:
            ...
            self.training_buffer2[agent_id].last_take_action_outputs = take_action_outputs
        ...
        for agent_id in next_info.agents:
            ...
            stored_take_action_outputs2 = self.training_buffer2[agent_id].last_take_action_outputs
